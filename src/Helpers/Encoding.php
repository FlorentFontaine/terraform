...
class Encoding
{
     ...
     *
     * @param string|array $text The string or array to convert.
     * @return string|array The same string or array, UTF8 encoded.
     */
    ...
    protected static function utf8_decode($text, $option = self::WITHOUT_ICONV)
    {
        if ($option == self::WITHOUT_ICONV || !function_exists('iconv')) {
            ...
            $ignore = $option === self::ICONV_IGNORE ? '//IGNORE' : '';
            $flag = $option === self::ICONV_TRANSLIT ? '//TRANSLIT' : $ignore;
